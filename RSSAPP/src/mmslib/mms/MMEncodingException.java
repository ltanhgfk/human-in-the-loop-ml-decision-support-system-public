...
/**
 * This exception is thrown when an error occurs when encoding a MMMessage
 * 
 * @author Anders Lindh
 * @copyright Copyright FlyerOne Ltd 2005
 * @version $Revision: 1.1.1.1 $ $Date: 2005/04/14 09:04:10 $
 */
public class MMEncodingException extends Exception {

	/**
	 * Constructor for MMEncodingException.
	 */
	public MMEncodingException() {
		super();
	}
	 ...
	 * @param arg0
	 */
	public MMEncodingException(String arg0) {
		super(arg0);
	}
