...
public class CWTPSegmResult extends CWTPPDU {
    private short sequenceNo = 0;

    public CWTPSegmResult(short sequenceNo, byte[] payload, int tid) {
        super(payload, tid, PDU_TYPE_SEGM_RESULT);
    ...
    public static void main(String[] args) {
        //CWTPSegmResult CWTPSegmResult1 = new CWTPSegmResult();
    }
}
