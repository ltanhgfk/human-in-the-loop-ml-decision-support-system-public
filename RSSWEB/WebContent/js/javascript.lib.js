...
function basicCalendarVN(){
	...
	document.write(dayarray[day]+", ngÃ y "+daym+" thÃ¡ng "+montharray[month]+" nÄƒm "+year);
...
function startClockVN(){
	...
	d.innerHTML=dayarray[nday]+", " + ntoday +"/" + nmonth +"/"+nyear + " &minus; " + nhours+":"+nmins+":"+nsecn+" "+ GMT;
